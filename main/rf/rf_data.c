 ...
 *
 * Implements functions for converting received RF data between raw,
 * binary, and tri-state representations.
 */
...
const DRAM_ATTR Protocol proto[] = {
    ...
    // Protocol 12: Conrad RS-200 alternate inverted protocol
